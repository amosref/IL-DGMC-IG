Instance: Inline-Instance-for-4142-1
...
* insurance.item.productOrService = $medical-service-moh#L9261 "בדיקת רופא נפרולוג במרפאה"
...
* error.extension.valueCoding = $medical-service-moh#L9
* error.code = $il-core-error-code#unknown-code "קוד לא מזוהה"