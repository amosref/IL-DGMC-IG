...
* supportingInfo[=].information = Reference(urn:uuid:899e19fd-ce66-400d-abca-bdc76f7e52db)
...
* supportingInfo[=].information.display = "בקשת ההתחייבות שיש לעדכן - עדכון פרטי התור"
