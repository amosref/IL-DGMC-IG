...
* identifier contains 
    nmr-pat-int-num 1..1 and 
    cml-pat-int-num 0..1 and 
    nmr-pat-tmp-num 0..1 and 
    ppn-unknown 0..*
...
// * identifier[ppn-unknown].system ^fixedUri.extension contains $extDAR named data-absent-reason 1..1
// * identifier[ppn-unknown].system ^fixedUri.extension[data-absent-reason].url = $extDAR
// * identifier[ppn-unknown].system ^fixedUri.extension[data-absent-reason].valueCode = #unknown

* identifier[ppn-unknown].system.extension contains $extDAR named data-absent-reason 1..1
* identifier[ppn-unknown].system.extension[data-absent-reason].url = $extDAR (exactly)
* identifier[ppn-unknown].system.extension[data-absent-reason].valueCode = #unknown (exactly)
* identifier[ppn-unknown].system = "unknown" // I added this. Kippi 18/8/24
